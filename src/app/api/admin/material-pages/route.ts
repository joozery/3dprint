...
const SEED_DATA = [
    ...
    },
    {
        ...
        shortDesc: "จุดกึ่งกลางระหว่าง PLA และ ABS ทนทาน พิมพ์ง่าย ใสเล็กน้อย เหมาะสำหรับชิ้นส่วนใช้งานทั่วไป",
    ...
    {
        slug: "carbon-fiber", name: "Carbon Fiber", fullName: "Carbon Fiber Reinforced Filament", order: 7,
...
export async function POST(req: NextRequest) {
    ...
    const item = await MaterialPageContent.create(body);
